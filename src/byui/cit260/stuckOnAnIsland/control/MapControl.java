...
public class MapControl {
    ...
    private static void assignScenesToLocations(Location[] locations) {
        ...
        locations[3].setRegularSceneType(new BuildCityScene()); 
        locations[4].setRegularSceneType(new RegularCityScene());
        locations[5].setRegularSceneType(new GatherCityScene());
        ...
        locations[11].setRegularSceneType(new GatherCityScene());
        locations[12].setRegularSceneType(new GatherCityScene()); 
        ...
        locations[17].setRegularSceneType(new GatherCityScene()); 
        locations[18].setRegularSceneType(new GatherCityScene()); 
        ...
        locations[22].setRegularSceneType(new GatherCityScene()); 
        locations[23].setRegularSceneType(new GatherCityScene()); 
        locations[24].setRegularSceneType(new RaftCityScene());
